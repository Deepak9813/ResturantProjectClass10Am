...
#Now, add EXTERNAL_APPS into INSTALLED_APPS
...
LOGIN_URL="login"        #login garne url       #name = 'login' waala
...
#in terminal ==> pip install "psycopg[binary]"
